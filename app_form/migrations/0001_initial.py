    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lengthOfStay', models.CharField(blank=True, max_length=255, null=True)),
                ('lengthOfStayType', models.CharField(blank=True, choices=[('Year/s', 'Year/s'), ('Month/s', 'Month/s'), ('Week/s', 'Week/s')], max_length=100, null=True)),
                ...
                ('birthOrder', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('fatherAge', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('motherAge', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('caregiverAge', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('caregiverContact', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disability', models.CharField(choices=[('Cleft Palate', 'Cleft Palate'), ('Cerebral Palsy', 'Cerebral Palsy'), ('Congenital Heart Disease', 'Congenital Heart Disease'), ('Hydrocepalus', 'Hydrocepalus'), ('Down Syndrome', 'Down Syndrome'), ('Global Development Delay', 'Global Development Delay'), ('None', 'None'), ('Others', 'Others')], default='None', max_length=100)),
                ('otherDisability', models.CharField(blank=True, max_length=255, null=True)),
